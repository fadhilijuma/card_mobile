...
public class PinReset extends MyBaseActivity {
    ...
    protected static final String TAG = PinReset.class.getName();
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (PhoneNumber.getText().toString().length() == 10) {
                            ...
                            if (isNetworkAvailable(getApplicationContext())) {
                                ...
                                new MaterialStyledDialog.Builder(PinReset.this)
    ...
    private void makeJsonObjectRequest(HashMap<String, String> params) {
        ...
        JsonObjectRequest req = new JsonObjectRequest(Config.PinReset, new JSONObject(params),
