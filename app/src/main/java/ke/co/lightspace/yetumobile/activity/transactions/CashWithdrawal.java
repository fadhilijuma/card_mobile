...
public class CashWithdrawal extends MyBaseActivity {
    ...
    static String Terminal_Type = "01";
    ...
    private boolean dialogCashWithdrawal() {
        String masked = maskNumber(sixteenDigit, "####xxxxxxxx####");

        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                context);

        alertDialogBuilder.setTitle("KUTOA PESA");
        alertDialogBuilder.setIcon(R.mipmap.loan);

        LayoutInflater li = LayoutInflater.from(context);
        final View dialogView = li.inflate(R.layout.transact_dialog, null);
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (pin.getText().toString().length()==4) {
                            ...
                            if (isNetworkAvailable(getApplicationContext())) {
                                ...
                                if (Integer.parseInt(amount.getText().toString()) >= 5000 && Integer.parseInt(amount.getText().toString()) <= 5000000) {

                                    new MaterialStyledDialog.Builder(CashWithdrawal.this)
                                            .setTitle("THIBITISHA KUTOA PESA")
                                            .setDescription("KIASI CHA PESA: TSHS. " + output)
    ...
    private void getEXPIRYDATE(String st) {
        int index;
    ...
    private void makeJsonObjectRequest(HashMap<String, String> params) {
        ...
        JsonObjectRequest req = new JsonObjectRequest(Config.cashwithdrawal, new JSONObject(params),
    ...
    private void Success(String message) {
        ...
        builder.setMessage(message).setTitle("KUTOA PESA")
                .setCancelable(false)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
