...
public class ChildFatherImage extends MyBaseActivity {
    ...
    private static final String TAG = ChildFatherImage.class.getSimpleName();
            ...
            public void onClick(View view) {
                if (imageView.getDrawable() == null) {
                    ...
                    if (imageRotate != null) {
                        ...
                        prefs.edit().putString("FatherImage", img_str).apply();
                        prefs.edit().putString("FatherImagePath", fileUri.getPath()).apply();
                    }

                    startActivity(new Intent(ChildFatherImage.this, ChildFatherCombined.class));
                }else{
                        Toast.makeText(getApplicationContext(), "Please Take Image", Toast.LENGTH_SHORT).show();
