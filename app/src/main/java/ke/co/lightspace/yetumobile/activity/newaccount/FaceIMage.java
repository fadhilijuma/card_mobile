...
public class FaceIMage extends MyBaseActivity {
    ...
    private static final String TAG = FaceIMage.class.getSimpleName();
    String cust = null;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (imageView.getDrawable() == null) {
                    ...
                    if (ImageUpdate){
                        startActivity(new Intent(FaceIMage.this, NSignature.class)
