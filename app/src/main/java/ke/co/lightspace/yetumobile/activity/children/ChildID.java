...
public class ChildID extends MyBaseActivity {
    ...
    private static final String TAG = ChildID.class.getSimpleName();
    String faceDetails;
    String PhoneNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhoneNumber = input.getStringExtra("PhoneNumber");
            ...
            public void onClick(View view) {
                if (imageView.getDrawable() == null) {
                    ...
                    if (isNetworkAvailable(getApplicationContext())){
                        ...
                        startActivity(new Intent(ChildID.this, UploadChild.class)
                        ...
                        Toast.makeText(getApplicationContext(),"Hauna Internet",Toast.LENGTH_LONG).show();
                    }
